            ...
            <div className="bg-light">
              ...
              <div className="container pt-3">
                ...
                <div className="row pt-3 pb-4">
                  ...
                  <div className="col">
                    <Link to="/placesH" className="custom-card">
                      <div
              ...
              <Container fluid>
                <div className="container pb-4">
                  ...
                  <div className="container pb-2 text-center">
                    ...
                    सेवा प्रदान करके विकलांग लोगों के लिए समावेश सुलभ स्थानों की
                    जानकारी उपलब्ध किया जा रहा है। हमारा उपयोगकर्ता के अनुकूल
                    डेटाबेस से सुलभ स्थानों की एक विस्तृत श्रृंखला पेश करता है
                    रेलवे स्टेशन से लेकर पर्यटकों के आकर्षण तक, और बीच में सब
                    कुछ हमारी टीम यह सुनिश्चित करने के लिए अथक रूप से काम करती
                    है कि हमारे सभी सूचीबद्ध स्थान उच्चतम पहुंच-योग्यता मानकों
                    को पूरा करते हैं। चाहे आप दोस्तों के साथ नाइट आउट या फैमिली
                    वेकेशन प्लान कर रहे हैं, हमारा प्लेटफ़ॉर्म मिलने वाले सुलभ
                    स्थानों को ढूंढना आसान बनाता है आपकी ज़रूरतें। हमारे समुदाय
                    में शामिल हों और दुनिया को एक बनाने में हमारी मदद करे| सभी
                    के लिए अधिक सुलभ और समावेशी स्थान।
                  </div>
                </div>
              </Container>
              {/*--------------- search in your city   ----------------*/}
                  ...
                  <div className="card mb-5 shadow">
                    <div>
                      <Tabs activeKey={tabKey} onSelect={(e) => initTabKey(e)}>
                        <Tab eventKey="one" title="स्थानों की सूची देखें">
                          <div className="p-3">
                            <div className="row">
                              {data.map((row) => (
                          ...
                          <div className="row text-left ">
                            ...
                            <div className="col-md-6">
                              <div className="text-end">
                                ...
                                <Link to="/add-grievH" rel="noopener noreferrer">
