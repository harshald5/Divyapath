          ...
          <Container fluid>
            <div className="container-fluid  ">
              <div className="row text-center ">
                <h1 className="p-5 HomePgTitle"> दिव्य पथ </h1>
              </div>
            ...
            <div className="row pt-5 pb-2 ">
              ...
              <div className="col">
                <div
                  ...
                  style={{ width: "auto" }}>
                  <div className="card-body ">
                    <h5 className="card-title p-1 fw-bold">पहुंच योग्य स्थान</h5>
                    <p className="card-text">हमारे साथ पहुंच योग्य स्थान सुनिश्चित करें</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col">
                <div
                  ...
                  <div className="card-body ">
                    ...
                    <p className="card-text">अपने आप को कुशल और री-स्किल करें</p>
                  </div>
                </div>
              </div>
            </div>
